  ...
  return (
    <AuthLayout>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <span className="text-sm font-medium text-[#0F172A]/40">or email</span>
        <div className="flex-1 h-px bg-[#0F172A]/5"></div>
      </div>
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex items-center gap-2 pt-1 pb-2">
          <input
            type="checkbox"
            id="remember"
            className="w-4 h-4 rounded border-[#0F172A]/20 text-[#FF6B35] focus:ring-[#FF6B35] transition-colors cursor-pointer"
          />
          <label
            htmlFor="remember"
            className="text-sm text-[#0F172A]/70 cursor-pointer select-none"
          >
            Remember me
          </label>
        </div>

        <button className="w-full bg-[#FF6B35] text-white font-medium py-3.5 rounded-xl hover:bg-[#e85a25] transition-all hover:-translate-y-0.5 shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-[#FF6B35] outline-none">
          Sign In
        </button>
      </form>
